    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="flex gap-4">
          ...
          <button className="flex-1 bg-red-600 text-white py-3 px-4 rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
            <Clock className="inline-block w-5 h-5 mr-2" />
            Clock Out
          </button>
        </div>
